...
<div class="super_container">
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-color:black";></div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="billing checkout_section">
						...
						<div class="section_subtitle">Masukan Identitas Lengkapmu!</div>
                ...
                <div>
									...
									<input type="text" id="alamat" name="address" class="checkout_input" >
								</div>
									<!-- Province -->
                ...
                <div>
									<label for="checkout_shipping">Shipping*</label>
									<select name="courierplan" id="courierplan" class="dropdown_item_select checkout_input cekongkir" require="required">
										<option value=""></option>
									</select>
								</div>
						</div>
					...
					<div class="order checkout_section">
						...
						<div class="order_list_container">
							<ul class="order_list">
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
                  <div class="order_list_title">Shipping Cost</div>
    ...
    $(document).ready(function(e){
      ...
      headers: {
            ...
            if(id_provinsi){
                jQuery.ajax({
                    ...
                    success:function(data){
                        $('#kota').empty();
                        $('#kota').append('<option value="0">Kota*</option>');
        ...
        $('.cekongkir').change(function(e){
            ...
            if(delivery > 0){
                $('#biaya-ongkir').text('Rp.'+delivery);
                $('#ongkir').val(delivery);
                $('#biaya-ongkir').append('<input type="hidden" id="biaya-ongkir" value="'+delivery+'">');
                var newsubtotal = ({{$subtotal}} + parseInt(delivery));
                $('#total-biaya').text(newsubtotal);
                $('#totalbiaya').val(newsubtotal);
            }
                ...
                jQuery.ajax({
                    ...
                    success: function(result){
                        $('#courierplan').empty();
                        $('#courierplan').append('<option value="0">Jenis Layanan*</option>');
                        $.each(result, function(key, value){
                        $.each(value.costs, function(key1, value1){
                        $.each(value1.cost, function(key2, value2){
                        $('#courierplan').append('<option value="'+ value2.value +'">' + value1.service + ' - ' + value1.description + ' - Rp.' +value2.value + ' - Estimasi : ' + value2.etd + ' Hari </option>');
                        // $('#biaya-ongkir').text('Biaya Pengiriman: Rp.'+value2.value);
                        // $('#ongkir').val(delivery);
                        // $('#biaya-ongkir').append('<input type="hidden" id="biaya-ongkir" value="'+value2.value+'">');
                        // $('#biaya-ongkir').append('<li>Estimasi sampai: '+value2.etd+'Hari</li>');
                        // $('#total-biaya').text({{$subtotal}}+value2.value);
                        // $('#totalbiaya').val({{$subtotal}}+value2.value);
                        });
                      });
                    });
                    }
