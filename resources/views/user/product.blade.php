...
<head>
    ...
    <link href="{{ asset('assets/User/plugins/font-awesome-4.7.0/css/font-awesome.min.css')}}" rel="stylesheet"
        type="text/css">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/User/plugins/OwlCarousel2-2.2.1/owl.carousel.css')}}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/User/plugins/OwlCarousel2-2.2.1/owl.theme.default.css')}}">
                ...
                <div class="row details_row">
                    ...
                    <div class="col-lg-6 mt-5">
                        <div class="details_image">
                            ...
                            @if($loop->iteration == 1)
                            <div class="details_image_large"><img src="/uploads/product_images/{{$jpg->image_name}}"
                                    alt="">
                                @php
                                $home = new Home;
                                ...
                                @endphp
                                @if($disc!=0)
                                <div style="background-color:red;" class="product_extra product_new"><a
                                        href="categories.html">-{{$disc}}%</a></div>
                                @endif
                            </div>
                            <div
                                ...
                                <div class="details_image_thumbnail active"
                                    data-image="/uploads/product_images/{{$jpg->image_name}}"><img
                                        src="/uploads/product_images/{{$jpg->image_name}}" alt=""></div>
                                @endif
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 mt-5">
                        <div class="details_content">
                            ...
                            <div class="text-secondary"><i class="fa fa-star"> {{number_format($products->product_rate,1)}} </i></div>
                            @php
                            $home = new Home;
                            ...
                            <div class="in_stock_container">
                                ...
                                @if ($products->stock <= 0) <span style="color:red;">Out of Stock!</span>
                                    @else
                                    @if ($products->stock <= 5) <span style="color:red;">Hurry Up!<span style="color:black;">({{$products->stock}})</span></span>
                                        @else
                                        <span>In Stock <span style="color:black;">({{$products->stock}})</span>
                                        </span>
                                    @endif
                                @endif
                            </div>
                            <div class="details_text">Deskripsi :
                                <p>{{$products->description}}</p>
                            </div>
                            <!-- Product Quantity -->
                            <div class="product_quantity_container">
                                @if (is_null(Auth::user()))
                                    @if ($products->stock<1) <button class="btn btn-primary btn-success tombol1" disabled><i
                                        class="fa fa-cart-plus mr-2" aria-hidden="true"></i> Purchase</button>
                                    <button class="btn btn-primary btn-rounded tombol1" disabled><i
                                            class="fa fa-cart-plus mr-2" aria-hidden="true"></i> Add to cart</button>
                                    @else
                                    <button class="btn btn-primary btn-success tombol1"><i class="fa fa-cart-plus mr-2"
                                            aria-hidden="true"></i> Purchase</button>
                                    <button class="btn btn-primary btn-rounded tombol1"><i class="fa fa-cart-plus mr-2"
                                            aria-hidden="true"></i> Add to cart</button>
                                    @endif
                                @else
                                    @if ($products->stock<1) <button class="btn btn-primary btn-success" class="tombol1"
                                        disabled>
                    ...
                    <div class="comments-list text-center text-md-left">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-2 col-12 mb-3">
                                ...
                                <img src="{{asset('/uploads/avatars/'.$item->user->profile_image)}}" alt="sample image"
                        ...
                        <div class="row mb-5" style="margin-left: 5%">
                            ...
                            <div class="col-sm-10 col-12">
                                ...
                                <a>
                                    ...
                                    <h5 style="color: #333333" class="user-name font-weight-bold"><span
                                            style="margin-right:5px;"
                                            class="badge success-color">Admin</span>{{$balasan->admin->name}}</h5>
