                            ...
                            <li>
                                    @if ($transaksi->status == "unverified" && !is_null($transaksi->proof_of_payment))
                                        ...
                                        <div class="d-flex flex-row bd-highlight mb-3">
                                            <form action="/transaksi/detail/status" method="POST">
                                              ...
                                              <button type="submit" class="btn btn-success btn-sm btn-block" onclick="return confirm('Apa yakin ingin acc pesanan ini?')">Verify</button>
                                            </form>
                                        </div>  
                                    @endif
                                    ...
                                    @if ($transaksi->status === 'verified')
                                            ...
                                            <form action="/transaksi/detail/status" method="POST">
                                                ...
                                                <button type="submit" class="btn btn-success btn-sm btn-block">Deliver Products</button>
                                            </form>
                                        </div>  
                                    @endif
                                        ...
                                        @else
                                            <div style="margin-top:10px;" class="d-flex justify-content-center">
                                                <button id="tombol" class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#modalContactForm">Proof Of Payment</button>
                                            </div>
                                        @endif

                                        <div style="margin-top:10px;" class="d-flex justify-content-center">
                                          <a href="/admin/transaksi"><button class="btn btn-warning btn-rounded btn-block">Back</button></a>
                                        </div>
                            </li>
