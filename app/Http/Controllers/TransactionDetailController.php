...
class TransactionDetailController extends Controller
{
    ...
    public function membatalkanPesanan(Request $request){
        ...
        foreach($transaksi->transaction_detail as $item){
            $produkk = Product::find($item->product_id);
            
        $user->notify(new UserNotification("<a href ='/transaksi/detail/".$transaksi->id."'>Status Transaksimu dari produk ".$produkk->product_name." telah diupdate</a>"));
        }
